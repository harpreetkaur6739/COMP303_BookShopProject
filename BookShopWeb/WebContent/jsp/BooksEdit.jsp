...
<t:genericpage>
	<h1>Edit Book</h1>
	<div class="btn-group">
		<a href="authors?bId=${book.getBookId()}" class="btn btn-primary">Set Authors</a>
		<a href="genres?bId=${book.getBookId()}" class="btn btn-primary">Set Genres</a>
	</div>
	<hr />
	...
	<form method="post">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input id="publishDate" name="publishDate" type="text" placeholder="Enter publish date (DD/MM/YYYY)" value="<fmt:formatDate value="${book.getPublishDate()}" pattern="dd/MM/yyyy" />" required class="form-control"
